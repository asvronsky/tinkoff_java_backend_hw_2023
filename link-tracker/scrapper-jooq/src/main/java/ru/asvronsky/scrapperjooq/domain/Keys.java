...
import ru.asvronsky.scrapperjooq.domain.tables.records.ChatRecord;
import ru.asvronsky.scrapperjooq.domain.tables.records.DatabasechangeloglockRecord;
import ru.asvronsky.scrapperjooq.domain.tables.records.LinkRecord;
import ru.asvronsky.scrapperjooq.domain.tables.records.SubscriptionRecord;

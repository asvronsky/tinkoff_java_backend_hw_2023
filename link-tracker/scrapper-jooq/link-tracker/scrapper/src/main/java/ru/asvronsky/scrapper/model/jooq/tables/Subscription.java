 ...
 */
package ru.asvronsky.scrapper.model.jooq.tables;
...
import ru.asvronsky.scrapper.model.jooq.Keys;
import ru.asvronsky.scrapper.model.jooq.Public;
...
public class Subscription extends TableImpl<SubscriptionRecord> {
    ...
    public List<ForeignKey<SubscriptionRecord, ?>> getReferences() {
        return Arrays.asList(Keys.SUBSCRIPTION__SUBSCRIPTION_LINK_ID_FKEY, Keys.SUBSCRIPTION__SUBSCRIPTION_CHAT_ID_FKEY);
    }
